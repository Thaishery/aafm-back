...
class UserManagerController extends AbstractController
{
  ...
  public function index(#[CurrentUser] ? User $user, Request $req, UserPasswordHasherInterface $passwordHasher): JsonResponse
  {
    //varifie data : 
    ...
    $userValidator = new UserEditorRoleValidator; 
    ...
    $userUpdater = new UserEditorOrmUpdate; 
